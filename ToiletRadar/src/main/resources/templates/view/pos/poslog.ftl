                        ...
                        <div class="ibox-content">
                            ...
                            <div class="sumbox border-top">
                                <div class="row m-t-md m-b-md">
                                    <div class="col-md-6">本页统计：共20条； 成功 <span class="text-success">20</span> 、 失败 <span
                                                class="text-danger"> 0 </span>； 金额：<span
                                                class="text-price text-success">￥200,000</span> 元
                                    </div>
                                    <div class="col-md-6 text-right">
                                        统计结果：共589条； 成功 <span class="text-success">23</span> 、 失败 <span
                                                class="text-danger"> 7 </span>； 金额：<span
                                                class="text-price text-success">￥898,665,899,00</span> 元
                                    </div>
                                </div>
                            </div>
