                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        <a href="#add_rslide" class="btn btn-primary" data-id="555555" data-toggle="rslide"
                           role="button" data-title="添加广告">添加广告 <i class="fa fa-plus"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-heading">
                    <div class="ibox-title p-l-slg">
                        <label class="checkbox-inline p-l-n"><input id="checkAll" type="checkbox" class="i-checks"
                                                                    value=""> 全选 </label>
                        ...
                        <table class="table table-centerbody table-striped table-condensed text-nowrap"
                            ...
                            <tr>
                                ...
                                <td><img class="smallimg" data-toggle="popover" data-trigger="hover" data-html="true"
                                         data-content="<img src='${ctx }/static/img/a2.jpg' height='200' >"
                                         src="${ctx }/static/img/a2.jpg"></td>
                                <td>2016-01-12</td>
                                <td class="text-right text-nowrap">
                                    <div class="btn-group ">
                                        <a href="#edit_rslide" class="btn btn-white btn-sm" data-id="5"
                                           data-toggle="rslide" data-title="首页广告通栏"><i class="fa fa-pencil"></i> 编辑</a>
                                        <a href="#" class="btn btn-white btn-sm delete"><i class="fa fa-trash"></i>
                                            删除</a>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>图片广告</td>
                                <td><a href="#" title="">http://www.baidu.com</a></td>
                                <td><img class="smallimg" data-toggle="popover" data-placement="left"
    ...
    <div class="rslide-body">
        ...
        <form class="form-horizontal" id="edit_form">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8 col-md-9 col-lg-10"><input placeholder="" value="" type="text"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8 col-md-9 col-lg-10">
                    <button data-loading-text="数据正在提交..." type="submit" autocomplete="off" id="myButton1"
