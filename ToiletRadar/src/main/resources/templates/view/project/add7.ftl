                ...
                <div class="ibox-content p-t-md">
                    <div class="m-b-sm">
                        <a href="#add_rslide" class="btn btn-primary" data-id="555555" data-toggle="rslide"
                           role="button" data-title="新增佣金规则">新增佣金规则 <i class="fa fa-plus"></i></a>
                    </div>
                    <div class="table-responsive ">
                        <table class="table table-centerbody table-striped table-condensed text-nowrap border-top"
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-primary btn-circle btn-sm" data-userid="1"
                                       onclick="setState(this)"><i class="fa fa-check"></i></a></td>
                                <td class="text-right text-nowrap">
                                    <div class="btn-group ">
                                        <a href="#edit_rslide" class="btn btn-white btn-sm" data-id="5"
                                           data-toggle="rslide" data-title="编辑信息"><i class="fa fa-pencil"></i> 查看</a>
    ...
    <div class="rslide-body">
        ...
        <form class="form-horizontal" id="add_form">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-11 col-md-6 col-lg-7">
                    <div><input type="radio" class="i-checks" value="option1" name="optionsRadios"> 审核通过后立马上线。 <i
                                class="fa fa-exclamation-circle text-warning fa-md" data-toggle="popover"
                                data-content="如果该产品存在已上线的佣金规则则需将目前线上的下线再手动上线!" data-trigger="hover"></i></div>
                    <div class="m-t-sm"><input type="radio" class="i-checks" value="option1" name="optionsRadios">
                        审核通过后手动上线。
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <label class="col-sm-10 col-md-5 col-lg-4 control-label">拥金发放方式 <span
                            class="text-danger">*</span></label>
                <div class="col-sm-11 col-md-6 col-lg-7">
                    <label class="checkbox-inline p-l-n"><input type="radio" class="i-checks" value="option1"
                                                                name="optionsRadios2"> 总价千分比</label>
                    <label class="checkbox-inline"><input type="radio" class="i-checks" value="option1"
                                                          name="optionsRadios2"> 固定金额</label>
                </div>
            </div>
            ...
            <div class="form-group">
                <label class="col-sm-10 col-md-5 col-lg-4 control-label">带看客户成交佣金 <span
                            class="text-danger">*</span></label>
                <div class="col-sm-11 col-md-6 col-lg-7"><input type="text" class="form-control" value=""
                                                                placeholder=""></div>
            </div>
            <div class="form-group">
                <label class="col-sm-10 col-md-5 col-lg-4 control-label">推荐客户成交佣金 <span
                            class="text-danger">*</span></label>
                <div class="col-sm-11 col-md-6 col-lg-7"><input type="text" class="form-control" value=""
                                                                placeholder=""></div>
            </div>
