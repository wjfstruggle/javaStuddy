                ...
                <div class="ibox-content p-t-slg">
                    <form name="entity" id="input_form" class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <select name="city" data-placeholder="-- 请选择 --" class="chosen-select" tabindex="2"
                                        required>
                                    <option value=""></option>
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label" for="shortName"><span class="text-danger">*</span>
                                项目经理 </label>
                            <div class="col-md-10">
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label" for="name"><span class="text-danger">*</span>
                                上下线</label>
                            <div class="col-md-10">
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label" for="daikanPro"><span class="text-danger">*</span>
                                报备生效期 </label>
                            <div class="col-md-10">
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label" for="daofangPro">到访保护期 <span
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label" for="tuijianPro">推荐保护期 <span
                                        class="text-danger">*</span></label>
                            <div class="col-md-10">
                                <div class="input-group">
