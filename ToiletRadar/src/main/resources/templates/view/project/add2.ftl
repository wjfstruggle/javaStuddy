        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content p-t-md">
                    <div class="m-b-sm">
                        <a href="#add_rslide" class="btn btn-primary" data-id="555555" data-toggle="rslide"
                           role="button" data-title="添加户型">添加户型 <i class="fa fa-plus"></i></a>
                    </div>
                    <div class="table-responsive ">
                        <table class="table table-centerbody table-striped table-condensed text-nowrap border-top"
                            ...
                            <tbody>
                            <tr>
                                <td><img class="smallimg" data-toggle="popover" data-trigger="hover" data-html="true"
                                         data-content="<img src='${ctx}/static/img/a2.jpg' width='300' height='200' >"
                                ...
                                <td class="text-right text-nowrap">
                                    <div class="btn-group ">
                                        <a href="#edit_rslide" class="btn btn-white btn-sm" data-id="555555"
                                           data-toggle="rslide" data-title="阳光两房5555 信息编辑"><i class="fa fa-pencil"></i>
                                            编辑</a>
                                        <a href="${ctx}/view/project/view" class="btn btn-white btn-sm"><i
                            ...
                            <tr>
                                <td><img class="smallimg" data-toggle="popover" data-trigger="hover" data-html="true"
                                         data-content="<img src='${ctx}/static/img/a1.jpg' width='300' height='200' >"
                                ...
                                <td class="text-right text-nowrap">
                                    <div class="btn-group ">
                                        <a href="#edit_rslide" class="btn btn-white btn-sm" data-id="33333"
                                           data-toggle="rslide" data-title="阳光两房333333333 信息编辑"><i
                            ...
                            <tr>
                                <td><img class="smallimg" data-toggle="popover" data-trigger="hover" data-html="true"
                                         data-content="<img src='${ctx}/static/img/a3.jpg' width='300' height='200' >"
                                         src="${ctx}/static/img/a3.jpg"></td>
                                <td><a href="#" class="td-link" title="">阳光两房</a></td>
                                <td>90.00㎡</td>
                                <td>2室2厅1卫</td>
                                <td>南北通透、户型方正</td>
                                <td class="text-right text-nowrap">
                                    <div class="btn-group ">
                                        <a href="#edit_rslide" class="btn btn-white btn-sm" data-id="11111"
                                           data-toggle="rslide" data-title="阳光两房22222 信息编辑"><i class="fa fa-pencil"></i>
                                            编辑</a>
                                        <a href="${ctx}/view/project/view" class="btn btn-white btn-sm"><i
                                                    class="fa fa-trash"></i> 删除</a>
                                    </div>
                            ...
                            <tr>
                                <td><img class="smallimg" data-toggle="popover" data-trigger="hover" data-html="true"
                                         data-content="<img src='${ctx}/static/img/a4.jpg' width='300' height='200' >"
                                         src="${ctx}/static/img/a4.jpg"></td>
                                <td><a href="#" class="td-link" title="">阳光两房</a></td>
                                <td>90.00㎡</td>
                                <td>2室2厅1卫</td>
                                <td>南北通透、户型方正</td>
                                <td class="text-right text-nowrap">
                                    <div class="btn-group">
                                        <a href="#edit_rslide" class="btn btn-white btn-sm" data-toggle="rslide"
                                           data-id="222222222" data-title="阳光两房 信息编辑"><i class="fa fa-pencil"></i>
                                            编辑</a>
                                        <a href="${ctx}/view/project/view" class="btn btn-white btn-sm"><i
                                                    class="fa fa-trash"></i> 删除</a>
                                    </div>
...
<div class="rslide fadeInRightBig" id="edit_rslide">
    ...
    <div class="rslide-body">
        ...
        <div class="spiner-example"
             style="position: absolute; width: 100%; height: 100%; background:rgba(255,255,255,.7); z-index: 90;">
        ...
        <form class="form-horizontal" id="edit_form">
            <div class="form-group">
                ...
                <div class="col-sm-11 col-md-7 col-lg-8"><input placeholder="" name="huxing" value="" type="text"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-11 col-md-7 col-lg-8"><input placeholder="" value="" type="text" class="form-control"
                                                                required="required"></div>
            </div>

            <div class="form-group">
                <label class="col-sm-12 col-md-4 col-lg-3 control-label">户型 <span class="text-danger">*</span></label>
                <div class="col-sm-11 col-md-7 col-lg-8"><input placeholder="" value="" type="text"
                                                                class="form-control"></div>
            </div>

            <div class="form-group">
                <label class="col-sm-12 col-md-4 col-lg-3 control-label">户型优势 <span class="text-danger">*</span></label>
                <div class="col-sm-11 col-md-7 col-lg-8"><input type="text" placeholder=""
            ...
            <div class="form-group">
                ...
                <div class="col-sm-11 col-md-7 col-lg-8"><input type="text" placeholder="" value=""
                                                                class="form-control"/></div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-11 col-md-7 col-lg-8">
                    <button data-loading-text="数据正在提交..." type="submit" autocomplete="off" id="myButton"
                            class="btn btn-primary btn-rounded btn-block"><i class="fa fa-check"></i> 填写完成，提交
                    </button>
                </div>
            </div>
        </form>
...
<div class="rslide fadeInRightBig" id="add_rslide">
    ...
    <div class="rslide-body">
        ...
        <form class="form-horizontal" id="add_form">
            ...
            <div class="form-group">
                <label class="col-sm-12 col-md-4 col-lg-3 control-label"><span class="text-danger">*</span> 户型面积
                </label>
                <div class="col-sm-11 col-md-7 col-lg-8"><input placeholder="" value="" type="text" class="form-control"
                                                                required="required"></div>
            </div>
            ...
            <div class="form-group">
                <label class="col-sm-12 col-md-4 col-lg-3 control-label"><span class="text-danger">*</span> 户型优势
                </label>
                <div class="col-sm-11 col-md-7 col-lg-8"><input type="text" placeholder=""
                                                                value="111111111111111111111111111111"
                                                                class="form-control" required="required"/></div>
            ...
            <div class="form-group">
                <label class="col-sm-12 col-md-4 col-lg-3 control-label" for="logoFile"><span
                            class="text-danger">*</span> 户型图</label>
                <div class="col-sm-11 col-md-7 col-lg-8">
