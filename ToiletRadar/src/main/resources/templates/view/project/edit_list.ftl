                            ...
                            <div class="table-responsive ">
                                <table class="table table-centerbody table-striped table-condensed text-nowrap"
                                    ...
                                    <tr>
                                        ...
                                        <td>项目经理－f</td>
                                        <td>审核通过</td>
                                        <td><a class="btn btn-primary btn-circle btn-sm" onclick="setState(this)"
                                               data-id="1"><i class="fa fa-check"></i></a></td>
                                        <td class="text-right text-nowrap">
                                            <div class="btn-group ">
                                                <a href="add_hezuo.html" class="btn btn-white btn-sm edit"><i
                                                            class="fa fa-eye"></i> 编辑/详细</a>
                                            </div>
                                        </td>
                                    </tr>
                                    </tbody>
