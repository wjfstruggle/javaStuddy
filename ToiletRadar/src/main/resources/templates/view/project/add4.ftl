                            ...
                            <div class="m-b-sm">
                                <div class="btn-group">
                                    <a href="#add_rslide" class="btn btn-primary" data-id="555555" data-toggle="rslide"
                                       role="button" data-title="新增房号"><i class="fa fa-plus"></i> 新增房号</a>
                                    <a href="#import_rslide" class="btn btn-white" data-toggle="rslide" role="button"
                                       data-title="批量导入房号"><i class="fa fa-arrow-circle-o-right"></i> 批量导入房号 </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table table-centerbody table-striped table-condensed text-nowrap border-top"
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-primary btn-circle btn-sm" data-userid="1"
                                       onclick="setState(this)"><i class="fa fa-check"></i></a> 在售
                                </td>
                            </tr>
                            </tbody>
                        </table>
    ...
    <div class="rslide-body">
        <form class="form-horizontal" id="add_form">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7 col-md-8"><input type="text" class="form-control" value="" placeholder="" required>
                </div>
            </div>
