                        ...
                        <div class="ibox-content p-t-slg">
                            <form class="form-horizontal" id="add_form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <select name="city" data-placeholder="-- 请选择 --" class="chosen-select"
                                                tabindex="2" required>
                                            <option value=""></option>
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label">楼盘名称 <span
                                                class="text-danger">*</span></label>
                                    <div class="col-md-10"><input type="text" class="form-control" value=""
                                                                  placeholder="" required></div>
                                </div>

                                <div class="form-group">
                                    <label class="col-md-2 control-label">证明文件 <span
                                                class="text-danger">*</span></label>
                                    <div class="col-md-10">
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label">登陆账号 <span
                                                class="text-danger">*</span></label>
                                    <div class="col-md-10">
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label">真实姓名 <span
                                                class="text-danger">*</span></label>
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" value="" placeholder="" required>
                                    </div>
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label">手机号码 <span
                                                class="text-danger">*</span></label>
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" value="" placeholder="" required>
                                    </div>
