                ...
                <div class="ibox-content p-t-md">
                    <div class="m-b-sm">
                        <a href="#add_rslide" class="btn btn-primary" data-id="555555" data-toggle="rslide"
                           role="button" data-title="添加楼盘动态">添加楼盘动态 <i class="fa fa-plus"></i></a>
                    </div>
                                ...
                                <td class="text-right text-nowrap">
                                    <div class="btn-group ">
                                        <a href="#edit_rslide" class="btn btn-white btn-sm" data-id="5"
                                           data-toggle="rslide" data-title="编辑信息"><i class="fa fa-pencil"></i> 编辑</a>
    ...
    <div class="rslide-body">
        ...
        <form class="form-horizontal" id="edit_form">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-11 col-md-7 col-lg-8"><textarea placeholder="" class="form-control" rows="3"
            ...
            <div class="form-group p-t-md">
                ...
                <div class="col-sm-11 col-md-7 col-lg-8">
                    <button data-loading-text="数据正在提交..." type="submit" autocomplete="off"
