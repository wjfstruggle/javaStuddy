                        ...
                        <div class="row">
                            <div class="col-md-12 tab-content">
                                <div id="tab-1" class="tab-pane fade">
                                    <input type="file" class="file-loading addFile" id="addFile1" name="logoFile"
                                           multiple>
            ...
            initialPreviewConfig: [
                {
                    ...
                    width: "120px",
                    height: "120px",
                    url: "http://plugins.krajee.com/site/file-delete",
                    key: 1
                }, //URL 为从服务端删除图片的地址
