                ...
                <div class="ibox-content p-t-md">
                    <div class="m-b-sm">
                        <a href="#add_rslide" class="btn btn-primary" data-id="555555" data-toggle="rslide"
                           role="button" data-title="新增佣金规则">新增优惠活动 <i class="fa fa-plus"></i></a>
                    </div>
                        ...
                        <table class="table table-centerbody table-striped table-condensed text-nowrap border-top">
                            ...
                            <tr>
                                ...
                                <td class="text-right text-nowrap">
                                    <div class="btn-group ">
                                        <a href="#add_rslide" class="btn btn-white btn-sm" data-id="5"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-11 col-md-8">
                    <label class="checkbox-inline p-l-n"><input type="radio" class="i-checks" value="option1"
                                                                name="optionsRadios" checked> 一次性全款 </label>
                    <label class="checkbox-inline"><input type="radio" class="i-checks" value="option1"
                                                          name="optionsRadios"> 分期付款 </label>
                    <label class="checkbox-inline"><input type="radio" class="i-checks" value="option1"
                                                          name="optionsRadios"> 按揭付款 </label>
                </div>
            </div>
            ...
            <div class="table-responsive ">
                <table class="table table-centerbody table-striped table-condensed text-nowrap border-top"
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="form-control" placeholder="" value=""></td>
                        <td class="text-right text-nowrap">
                            <div class="btn-group"><a href="#add_rslide"
                                                      class="btn btn-danger btn-rounded delete btn-xs"><i
                                            class="fa fa-times"></i> 删除</a></div>
                        </td>
                    </tr>
                    </tbody>
                </table>
