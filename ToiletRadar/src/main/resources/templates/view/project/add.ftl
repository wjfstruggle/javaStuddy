                ...
                <div class="col-md-12">
                    ...
                    <div class="stepy-tab">
                        <ul id="" class="stepy-titles clearfix">
                            ...
                            <li><a href="${ctx }/view/project/add2">
                                    <div>户型管理</div>
                                </a></li>
                            <li><a href="${ctx }/view/project/add3">
                                    <div>楼盘相册</div>
                                </a></li>
                            <li><a href="${ctx }/view/project/add4">
                                    <div>销控管理</div>
                                </a></li>
                            <li><a href="${ctx }/view/project/add5">
                                    <div>基础信息</div>
                                </a></li>
                            <li><a href="${ctx }/view/project/add6">
                                    <div>户型管理</div>
                                </a></li>
                            <li><a href="${ctx }/view/project/add7">
                                    <div>楼盘相册</div>
                                </a></li>
                            <li><a href="${ctx }/view/project/add8">
                                    <div>销控管理</div>
                                </a></li>
                            <li><a href="${ctx }/view/project/add9">
                                    <div>销控管理</div>
                                </a></li>
                        </ul>
                    </div>
                ...
                <div class="ibox-content p-t-slg">
                    <form name="entity" id="input_form" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="col-sm-12 col-md-3 col-lg-2 control-label" for="name">楼盘名称 <span
                                        class="text-danger">*</span></label>
                            <div class="col-sm-12 col-md-9 col-lg-10">
                                <input type="text" id="name" name="name" value="" placeholder="请输入楼盘全称"
                                       class="form-control" required>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-sm-12 col-md-3 col-lg-2 control-label" for="shortName">城市 <span
                                        class="text-danger">*</span></label>
                            <div class="col-sm-12 col-md-9 col-lg-10">
                                <input type="text" id="shortName" name="shortName" value="" placeholder="请输入楼盘的简称"
                                       class="form-control" required>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-sm-12 col-md-3 col-lg-2 control-label" for="address">楼盘地址 <span
                                        class="text-danger">*</span></label>
                            <div class="col-sm-12 col-md-9 col-lg-10">
                                <input type="text" id="address" name="address" value="" placeholder="请输入楼盘地址"
                                       class="form-control" required>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-sm-12 col-md-3 col-lg-2 control-label" for="smsPrefix">开发商保护期 <span
                                        class="text-danger">*</span></label>
                            <div class="col-sm-12 col-md-9 col-lg-10">
                                <div class="input-group">
                                    <input type="text" id="smsPrefix" name="smsPrefix" value="" placeholder="请输入短信前缀"
                                           class="form-control" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12 col-md-9 col-lg-10">
                                <label class="checkbox-inline p-l-n"><input type="checkbox" class="i-checks" value="1">
                                    板楼 </label>
                                <label class="checkbox-inline"><input type="checkbox" class="i-checks" value="2"
                                                                      checked> 塔楼 </label>
                                <label class="checkbox-inline"><input type="checkbox" class="i-checks" value="3"> 独栋
                                </label>
                                <label class="checkbox-inline"><input type="checkbox" class="i-checks" value="4"> 联排
                                </label>
                                <label class="checkbox-inline"><input type="checkbox" class="i-checks" value="5"> 双拼
                                </label>
                                <label class="checkbox-inline"><input type="checkbox" class="i-checks" value="6"> 叠拼
                                </label>
                                <label class="checkbox-inline"><input type="checkbox" class="i-checks" value="7"> 低层
                                </label>
                                <label class="checkbox-inline"><input type="checkbox" class="i-checks" value="8"
                                                                      checked> 多层 </label>
                                <label class="checkbox-inline"><input type="checkbox" class="i-checks" value="9"> 中高层
                                </label>
                                <label class="checkbox-inline"><input type="checkbox" class="i-checks" value="10"> 高层
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12 col-md-9 col-lg-10">
                                ...
                                <label class="checkbox-inline"><input type="checkbox" class="i-checks" value="2"
                                                                      checked> 别墅 </label>
                                <label class="checkbox-inline"><input type="checkbox" class="i-checks" value="3"> 商铺
                                </label>
                                <label class="checkbox-inline"><input type="checkbox" class="i-checks" value="4"> 写字楼
                                </label>
                                <label class="checkbox-inline"><input type="checkbox" class="i-checks" value="5"
                                                                      checked> 商住 </label>
                                <label class="checkbox-inline"><input type="checkbox" class="i-checks" value="6"> 酒店式公寓
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12 col-md-9 col-lg-10">
                                <label class="checkbox-inline p-l-n"><input type="checkbox" class="i-checks" value="1"
                                                                            checked> 毛坯 </label>
                                <label class="checkbox-inline"><input type="checkbox" class="i-checks" value="2"> 精装
                                </label>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-12 col-md-9 col-lg-10">
                                <div class="input-group">
                                        <span class="input-group-addon">
                                            <label class="checkbox-inline p-l-n p-t-n"><input type="radio"
                                                                                              name="colseType"
                                                                                              class=" jdate" value="现房"
                                                                                              checked> 现房 </label>
                                            <label class="checkbox-inline p-t-n"><input type="radio" name="colseType"
                                                                                        class=" jdate"
                                                                                        value="期房"> 期房 </label>
                                        </span>
                                    <input type="text" value="" name="colseDay" disabled placeholder="请选择交房时间"
                                           class="form-control date" id="colseDay">
                                </div>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-12 col-md-9 col-lg-10">
                                <textarea maxlength="255" rows="2" placeholder="周边的公交线路"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12 col-md-9 col-lg-10">
                                <textarea maxlength="255" rows="2" placeholder="周边的地铁线路"
                                          class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12 col-md-9 col-lg-10">
                                <textarea maxlength="255" rows="2" placeholder="周边的其它配套设施"
                                          class="form-control"></textarea>
                            </div>
                        </div>
