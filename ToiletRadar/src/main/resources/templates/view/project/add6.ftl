                ...
                <div class="ibox-content p-t-md">
                    <div class="m-b-sm">
                        <a href="#add_rslide" class="btn btn-primary" data-id="555555" data-toggle="rslide"
                           role="button" data-title="新增产品">新增产品 <i class="fa fa-plus"></i></a>
                    </div>
    ...
    <div class="rslide-body">
        ...
        <form class="form-horizontal" id="edit_form">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-11 col-md-7 col-lg-8"><input type="text" placeholder="" value="" class="form-control"
                                                                required="required"/></div>
            </div>
            <div class="form-group">
                <label class="col-sm-10 col-md-4 col-lg-3 control-label">开发商补助方式 <span
                            class="text-danger">*</span></label>
                <div class="col-sm-11 col-md-7 col-lg-8"><input type="text" placeholder="" value="" class="form-control"
                                                                required="required"/></div>
            </div>
            <div class="form-group">
                <label class="col-sm-10 col-md-4 col-lg-3 control-label">开发商补助金额 <span
                            class="text-danger">*</span></label>
                <div class="col-sm-11 col-md-7 col-lg-8"><input type="text" placeholder="" value="" class="form-control"
                                                                required="required"/></div>
            </div>
            <div class="form-group">
                <label class="col-sm-10 col-md-4 col-lg-3 control-label">团购费补贴金额 <span
                            class="text-danger">*</span></label>
                <div class="col-sm-11 col-md-7 col-lg-8"><input type="text" placeholder="" value="" class="form-control"
                                                                required="required"/></div>
            </div>
    ...
    <div class="rslide-body">
        ...
        <form class="form-horizontal" id="add_form">
            ...
            <div class="form-group">
                <label class="col-sm-10 col-md-4 col-lg-3 control-label">产品属性 <span class="text-danger">*</span></label>
                <div class="col-sm-11 col-md-7 col-lg-8">
                    <label class="checkbox-inline p-l-n"><input type="radio" name="radio2" class="i-checks" value="1">
                        团购项目 </label>
                    <label class="checkbox-inline"><input type="radio" name="radio2" class="i-checks" value="2" checked>
                        导客项目 </label>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="col-sm-10 col-md-4 col-lg-3 control-label">款项来源 <span class="text-danger">*</span></label>
                <div class="col-sm-11 col-md-7 col-lg-8">
                    <label class="checkbox-inline p-l-n"><input type="radio" name="radio1" class="i-checks" value="1">
                        客户剧团购费 </label>
                    <label class="checkbox-inline"><input type="radio" name="radio1" class="i-checks" value="2" checked>
                        开发商补助 </label>
                    <label class="checkbox-inline"><input type="radio" name="radio1" class="i-checks" value="2" checked>
                        混合 </label>
                </div>
