                                ...
                                <div class="col-md-12">
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-lg-7 col-xs-6"><p class="form-control-static">
                                                    团购项目</p></div>
                                        </div>
                                        ...
                                        <div class="hr-line-dashed"><span
                                                    class="badge badge-posion label-primary">门店经纪人</span></div>
                                        <div class="form-group">
                                        ...
                                        <div class="hr-line-dashed"><span
                                                    class="badge badge-posion label-primary">会员经纪人</span></div>
                                        <div class="form-group">
                                            <label class="col-md-6 col-lg-5 col-xs-7 control-label">带看客户成交佣金： </label>
                                            <div class="col-md-6 col-lg-7 col-xs-6"><p class="form-control-static">
                                                    1.0%</p></div>
                                ...
                                <div class="col-md-12">
                                    <form id="add_form">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <label class="checkbox-inline p-l-n"><input type="radio"
                                                                                            class="i-checks"
                                                                                            value="option1"
                                                                                            name="optionsRadios2">
                                                    通过</label>
                                                <label class="checkbox-inline"><input type="radio" class="i-checks"
                                                                                      value="option1"
                                                                                      name="optionsRadios2"> 拒绝</label>
                                            </div>
                                        </div>
                                        <div class="form-group">
