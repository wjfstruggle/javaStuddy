                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-4 ">
                        <a href="#add_rslide" class="btn btn-primary" data-id="555555" data-toggle="rslide"
                           role="button" data-title="添加补贴">添加补贴 <i class="fa fa-plus"></i></a>
                    </div>
                            ...
                            <div class="form-group col-md-6 col-sm-8">
                                <div class="input-group ">
                                    ...
                                    <span class="input-group-btn"><button
                                                class="btn btn-primary btn-sm m-b-none">搜索</button></span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content p-t-md">
                    <div class="table-responsive ">
                        <table class="table table-striped table-condensed text-nowrap table-centerbody"
                               id="editable-sample">
                            <thead>
                            <tr>
                                <th>项目名称</th>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <div class="btn-group ">
                                        <a href="#myModa-reset" data-toggle="modal" data-id="1"
                                           class="btn btn-white btn-sm through"><i class="fa fa-jpy"></i> 进账指示</a>
                                        <a href="#myModa-msg" data-toggle="modal" data-id="1"
                                           class="btn btn-white btn-sm through"><i class="fa fa-reply-all"></i> 反馈</a>
                                        <a href="#add_rslide" data-id="555555" data-toggle="rslide" role="button"
                                           class="btn btn-white btn-sm through"><i class="fa fa-pencil"></i> 编辑</a>
                                    </div>
                                </td>
                            </tr>
                            <tr>
    ...
    <div class="rslide-body">
        <form class="form-horizontal" id="add_form">
            <div class="form-group">
                ...
                <div class="col-sm-8 col-md-9 col-lg-10"><input placeholder="" name="huxing" value="" type="text"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8 col-md-9 col-lg-10"><input placeholder="" value="" type="text" class="form-control"
            ...
            <div class="form-group">
                <label class="col-sm-4 col-md-3 col-lg-2 control-label" for="logoFile">发票图片 <span
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="resetform" id="resetform">
                    <div class="form-group"><label class="control-label" for="order_id">补贴总金额</label><input type="text"
                                                                                                            id="restcode"
                                                                                                            name="restcode"
                                                                                                            maxlength="6"
                                                                                                            placeholder="请输入验证码"
                    ...
                    <div class="form-group"><label class="control-label" for="order_id">已到账金额</label><input type="text"
                                                                                                            name="restcode"
                                                                                                            maxlength="6"
                                                                                                            placeholder="请输入验证码"
                                                                                                            class="form-control"
                    ...
                    <label class="control-label" for="order_id">补贴总金额</label><input type="text" name="restcode"
