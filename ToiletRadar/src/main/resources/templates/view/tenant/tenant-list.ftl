            ...
            <div class="ibox-content m-b-sm border-bottom">
                <div class="row">
                    <div class="col-md-6 col-sm-4">
                        <a class="btn btn-primary" href="${ctx }/view/tenant/tenant-add"> 添加电商 <i
                                    class="fa fa-plus"></i>
                        </a>
                    </div>
                                    ...
                                    <div class="table-td">
                                        <div class="input-group m-b-none">
                                            <input type="text" class="input-sm form-control" name="end" value=""
                                                   placeholder="输入账号搜索"> <span class="input-group-btn"><button
                                                        type="button" class="btn btn-sm btn-primary ">查询</button></span>
                                        </div>
                                    </div>
                                    <div class="table-td">
                                        <div class="table-td m-l-sm pull-right">
                                            <a class="btn btn-sm btn-primary dropdown-toggle" role="button"
                                               data-toggle="collapse" href="#collapseExample" aria-expanded="false"
                                               aria-controls="collapseExample"> 高级搜索 <span class="caret"></span></a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label class="control-label" for="order_id">用户名称</label> <input type="text"
                                                                                                    id="order_id"
                                                                                                    name="order_id"
                                                                                                    value=""
                                                                                                    placeholder="输入用户名称"
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label class="control-label">电商</label> <select data-placeholder="-- 请选择电商 --"
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label class="control-label">楼盘</label> <select data-placeholder="-- 请选择楼盘 --"
                                                                                    class="chosen-select" tabindex="2">
                                        <option value=""></option>
                                        <option value="1">电商公司 1</option>
                                        <option value="2">电商公司 2</option>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="control-label">经纪公司门店</label> <select name=""
                                                                                                class="form-control input-s-sm inline">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="control-label">&nbsp;</label> <select name=""
                                                                                                class="form-control input-s-sm inline">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label class="control-label">角色</label> <select name=""
                                                                                    class="form-control input-s-sm inline">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label class="control-label">城市</label> <select data-placeholder="-- 请选择楼盘 --"
                                                                                    class="chosen-select" tabindex="2">
                            ...
                            <div class="table-responsive ">
                                <table class="table table-centerbody table-striped table-condensed text-nowrap"
                                    ...
                                    <tr>
                                        ...
                                        <td>17168</td>
                                        <td>2015-10-09</td>
                                        <td><a class="btn btn-primary btn-circle btn-sm" type="button"
                                               data-userid="1"><i class="fa fa-check"></i></a></td>
                                        <td class="text-right text-nowrap">
                                            <div class="btn-group ">
                                                <button class="btn btn-white btn-sm edit" data-userid="[id]"
                                                        data-toggle="modal" data-target="#modal-form">
                                                    <i class="fa fa-pencil"></i> 编辑
                                                </button>
                                                <button class="btn-white  btn btn-sm rset" data-userid="1"
                                                        data-toggle="modal" data-target="#myModa-reset">
