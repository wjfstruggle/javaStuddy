                ...
                <div class="ibox-content p-t-slg">
                    <form name="entity" id="input_form" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="col-sm-12 col-md-4 col-lg-2 control-label" for="title"><span
                        ...
                        <div class="form-group">
                            <label class="col-sm-12 col-md-4 col-lg-2 control-label" for="description"><span
                                        class="text-danger">*</span>内容</label>
                            <div class="col-sm-12 col-md-7 col-lg-9">
                                <input type="text" id="description" name="description" value="" placeholder="请输入内容"
                                       class="form-control" required>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-sm-12 col-md-4 col-lg-2 control-label" for="address"><span
                                        class="text-danger">*</span>地址</label>
                            <div class="col-sm-12 col-md-7 col-lg-9">
                                <input type="text" id="address" name="address" value="" placeholder="请输入地址"
                                       class="form-control" required>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-sm-12 col-md-4 col-lg-2 control-label" for="newsTime"><span
                                        class="text-danger">*</span>发生时间</label>
                            <div class="col-sm-12 col-md-7 col-lg-9">
                                <input type="text" id="newsTime" name="newsTime" value=""
                                       onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm',firstDayOfWeek:1,readOnly:true})"
                                       placeholder="请选择发生时间" class="form-control Wdate" required>
                            </div>
                        </div>
