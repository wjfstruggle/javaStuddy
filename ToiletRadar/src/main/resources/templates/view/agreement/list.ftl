            ...
            <div class="ibox-content m-b-sm ibox-content-t border-bottom" id="ibox-content">
                <div class="row">
                    ...
                    <div class="form-group col-sm-4 col-md-4 col-lg-5">
                        <div class="btn-group">
                            <a class="btn btn-primary active" data-toggle="collapse" data-target="#collapseOne"
                               aria-expanded="false"><i class="fa fa-plus"></i> 预约</a>
                            <a class="btn btn-primary" data-toggle="collapse" data-target="#collapseTwo"
                               aria-expanded="false"><i class="fa fa-plus"></i> 认购 </a>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="form-group col-sm-8 col-md-6 col-lg-5">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn"><button class="btn btn-primary" id="search_yuyue"><i
                                                    class="fa fa-search"></i> 查询预约</button>
                                        </button></span>
                                </div>
                            </div>
                            <div class="form-group col-sm-4 col-md-6 col-lg-7">
                                <button class="btn btn-warning" data-toggle="rslide" data-target="#add_rslide"
                                        data-title="现场客户预约"><i class="fa fa-edit"></i> 作为现场客户预约
                                </button>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group col-md-4">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn"><button class="btn btn-primary"><i
                                                    class="fa fa-search"></i> 查询认购</button></span>
                                </div>
                            </div>
                            <div class="form-group col-md-8">
                                <button class="btn btn-success" data-toggle="rslide" data-target="#add_rslide"
                                        data-title="现场客户认购"><i class="fa fa-edit"></i> 作为现场客户认购
                                </button>
                            </div>
                        </div>
                    </div>
                                ...
                                <td class="text-right">
                                    <div class="btn-group ">
                                        <a class="btn-white  btn btn-sm delete" data-userid="1"><i
                                                    class="fa fa-external-link"></i> 转认购</a>
                                        <a class="btn btn-white btn-sm edit" role="button" data-userid="1"
                                           data-toggle="modal" data-target="#modal-form"><i class="fa fa-pencil"></i> 签约</a>
                                        <a class="btn-white  btn btn-sm delete" data-userid="1"><i
                                                    class="fa fa-cny"></i> 收款</a>
                                        <a class="btn-white  btn btn-sm delete" data-userid="1"><i
