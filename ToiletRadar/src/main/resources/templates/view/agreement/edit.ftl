                        ...
                        <div class="ibox-heading">
                            <div class="ibox-title">
                                ...
                                <div class="ibox-tools">
                                    <a class="tool-btn" data-item="house" data-event="edit"><i class="fa fa-pencil"></i>
                                        编辑</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <form class="form-horizontal" id="house_form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        <select name="property" class="form-control change onchange"
                                                disabled="disabled">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        <div class="input-group">
                                            <input type="text" class="form-control change" value="" placeholder=""
                                                   disabled="disabled">
                    ...
                    <div class="ibox">
                        <div class="ibox-heading">
                            <div class="ibox-title">
                                <h5>客户信息</h5>
                                <div class="ibox-tools">
                                    <a class="tool-btn" data-item="customer" data-event="edit"><i
                        ...
                        <div class="ibox-content p-t-md">
                            <form class="form-horizontal" id="customer_form">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-lg-9"><input type="text" class="form-control" value="陈小林"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-lg-9"><input type="text" class="form-control"
                                                                          value="13598821365" placeholder=""
                                                                          readonly="readonly" disabled="disabled"></div>
                                </div>

                                <div class="form-group">
                                    <label class="col-md-4 col-lg-3 control-label">客户2名称</label>
                                    <div class="col-md-8 col-lg-9"><input type="text" class="form-control change"
                                                                          value="陈大宝" placeholder=""
                                                                          disabled="disabled"></div>
                                </div>
                    ...
                    <div class="ibox">
                        <div class="ibox-heading">
                            <div class="ibox-title">
                                <h5>合同信息</h5>
                                <div class="ibox-tools">
                                    <a class="tool-btn" data-item="rengou" data-event="edit"><i
                                                class="fa fa-pencil"></i> 编辑</a>
                                </div>
                            </div>
                        </div>
                        <div class="ibox-content p-t-md">
                            <form class="form-horizontal" id="rengou_form">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-lg-9"><input type="text" class="form-control change"
                                                                          value="003325254545" placeholder=""
                                                                          disabled="disabled" readonly="readonly"></div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 col-lg-3 control-label">合同状态</label>
                                    <div class="col-md-8 col-lg-9"><input type="text" class="form-control change"
                                                                          value="认购,已付款,不可结佣" placeholder=""
                                                                          disabled="disabled" readonly="readonly"></div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        <div class="input-group">
                                            <input type="text" class="form-control change" value="20000.10"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        <div class="input-group">
                                            <input type="text" class="form-control change" value="10000.00"
                                                   placeholder="" disabled="disabled" readonly="readonly">
                                            <span class="input-group-addon"> 元 </span>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-lg-9"><input type="text" class="form-control change"
                                                                          value="" placeholder="" disabled="disabled">
                                    </div>
                                </div>
                                ...
                                <div class="form-group hidden" id="rengou_btn">
                                    <div class="col-sm-8 col-sm-offset-4 col-lg-offset-3">
                                        <button class="btn btn-primary" type="submit" id="myButton3"><i
                                                    class="fa fa-check"></i> 填写完成，提交！
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="table-responsive ">
                                <table class="table table-centerbody table-striped table-condensed text-nowrap"
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group ">
                                                <a class="btn-primary  btn btn-sm cancel" data-infoid="1"><i
                                                            class="fa fa-minus-circle"></i> 取消</a>
                                            </div>
                                        </td>
                                    </tr>
                                    </tbody>
