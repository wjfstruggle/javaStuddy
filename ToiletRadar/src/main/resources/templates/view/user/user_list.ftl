                    ...
                    <div class=" col-lg-4 col-md-6 col-sm-8 ">
                        <div class="tablesearch pull-right m-t-xs">
                            ...
                            <div class="table-td m-l-sm pull-right">
                                <a class="btn btn-sm btn-primary dropdown-toggle" role="button" data-toggle="collapse"
                                   href="#collapseExample" aria-expanded="false" aria-controls="collapseExample"> 高级搜索
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="order_id" name="order_id" value="" placeholder="输入用户名称"
                                           class="form-control">
                                </div>
                            </div>
                            <div class="col-sm-4">
                            ...
                            <div class="table-responsive ">
                                <table class="table table-centerbody table-striped table-condensed text-nowrap"
                                    ...
                                    <tr>
                                        ...
                                        <td>上海屋瓴</td>
                                        <td>
                                            <a class="btn btn-primary btn-circle btn-sm" onclick="setState(this)"
                                               data-id="1"><i class="fa fa-check"></i></a>
                                        </td>
                                        <td class="text-right text-nowrap">
                                            <div class="btn-group ">
                                                <button class="btn btn-white btn-sm edit" data-userid="1"
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right text-nowrap">
                                            <div class="btn-group ">
                                                <button class="btn btn-white btn-sm edit" data-userid="1"
                                                        data-toggle="modal" data-remote="edit_show.html"
                                                        data-target="#modal-form2"><i class="fa fa-pencil"></i> 编辑
                                                </button>
                                                <button class="btn-white  btn btn-sm rset" data-userid="1"
                                                        data-toggle="modal" data-target="#myModa-reset"><i
                                                            class="fa fa-eye"></i> 重置密码
            ...
            <div class="modal-body">
                ...
                <form role="form" id="add" name="add" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="username" name="usseracc" placeholder="请输入6-12位中英文符" required
                                   class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">真实姓名</label>
                        <div class="col-sm-8"><input type="text" name="userName" placeholder="请输入姓名,2-4位中文字符"
                                                     class="form-control"></div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">手机号</label>
                        <div class="col-sm-8"><input type="tel" id="phoneNum" placeholder="请输入11位手机号码" name="phoneNum"
                                                     class="form-control"></div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">确认手机号</label>
                        <div class="col-sm-8"><input type="tel" placeholder="再次输入手机号码" name="sphoneNum"
                                                     class="form-control"></div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select name="city" id="city" data-placeholder="-- 请选择 --" class="chosen-select"
                                    onchange="appendSelect();" tabindex="2" required>
                                <option value=""></option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select data-placeholder="-- 请选择 --" id="city2" name="round" class="chosen-select"
                                    tabindex="4" required>
                                <option value=""></option>
                                <option value="1">楼盘一</option>
                                <option value="2">United Kingdom</option>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="resetform" id="resetform">
                    <div class="form-group"><label class="control-label" for="order_id">输入验证码</label><input
                                name="userid" id="userid" type="hidden" value=""> <input type="text" id="restcode"
                                                                                         name="restcode" maxlength="6"
                                                                                         placeholder="请输入验证码"
                                                                                         class="form-control" value="">
                    </div>
                    <div class="form-group"><a href="#" title="换一张"><img src="" id="codeimg" alt="点击刷新" width="150"
                                                                         height="40">&nbsp;&nbsp;换一张</a></div>
                    <div class="form-group m-t-sm">
